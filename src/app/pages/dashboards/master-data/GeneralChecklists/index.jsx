    ...
    <div className="bg-white">    
      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex space-x-2">
            ...
            <Button 
              ...
              onClick={() => navigate(`/dashboards/master-data/general-checklists/add-new-master-matrix`)}
            >
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <Button 
              className="text-white px-4 py-2 rounded bg-indigo-500 hover:bg-fuchsia-500"
              onClick={() => navigate(`/dashboards/master-data/general-checklists/add-new-general-checklist-matrix`)}
            >
