...
//   const labId = params.get("labId"); // Add this line
...
//       onClick: () =>
//         navigate(
//           `/dashboards/material-list/electro-technical/maintenance-equipment-history/clone-certificate-details?fid=${fid}&cid=${cid}&labId=${labId}`
//         ),
//     },
...
export function RowActions({ row, table }) {
  ...
  const actions = [
    ...
    // Add IMC
    {
      ...
      onClick: () =>
        navigate(
          `/dashboards/material-list/electro-technical/maintenance-equipment-history/add-imc?fid=${fid}&cid=${cid}&labId=${labId}`
        ),
    },
